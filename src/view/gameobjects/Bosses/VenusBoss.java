...
* @since   2017-02-18 
*/
public class VenusBoss extends AbstractBoss {
    
    private PhysicsController.DIRECTION direction;
    private long lastJumpTime;
    
    public VenusBoss(Point loc) {
        super(loc, "sprite_sheet_alian_7_walk_left_300x351", "sprite_sheet_alian_7_walk_right_300x351");
