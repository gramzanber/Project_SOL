...
* @since   2017-02-18 
*/
public class SunBoss extends AbstractBoss {
    
    private PhysicsController.DIRECTION direction;
    private long lastJumpTime;
    
    public SunBoss(Point loc) {
        super(loc, "sprite_sheet_alian_8_walk_left_400x210", "sprite_sheet_alian_8_walk_right_400x210");
