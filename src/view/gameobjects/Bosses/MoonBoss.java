...
* @since   2017-02-18 
*/
public class MoonBoss extends AbstractBoss {
    
    private PhysicsController.DIRECTION direction;
    private long lastJumpTime;
    
    public MoonBoss(Point loc) {
        super(loc, "sprite_sheet_alian_9_walk_left_300x452", "sprite_sheet_alian_9_walk_right_300x452");
