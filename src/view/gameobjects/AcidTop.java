...
* @since   2017-02-18 
*/
public class AcidTop extends Tile {


    private static BufferedImage acidTopSpriteSheet = null;
    private int step;
    ...
    * @param loc
    */
    public AcidTop(Point loc, ID id) {
        //call superclass constructor
        super(loc);
        this.id = id;
        
        animationController = new AnimationController(AnimationController.Mode.AUTO, "acid_top");
