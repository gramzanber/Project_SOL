...
public class FlakCannon extends Weapon {
    ...
    public FlakCannon(float sx, float sy, RenderableObject owner) {
        ...
        super.boundingBox = new Rectangle(x + 50, y + 25, 110, 120);
        
        deleteFlak = new Point(x + 250, y + 25);
        pyc = new PhysicsController(this);
        
        animationController = new AnimationController(AnimationController.Mode.AUTO, "FlakCannon");
        animationController.setFps(18);
        animationController.setSpriteSheet("FlakCannon");
...
//       
        Rectangle boundingBoxForRendering = new Rectangle(translatedX, translatedY, 103, 111);
