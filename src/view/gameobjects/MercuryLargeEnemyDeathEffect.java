...
* @since   2017-02-18 
*/
public class MercuryLargeEnemyDeathEffect extends RenderableObject {
    
    private AnimationController animationController;
    
    public MercuryLargeEnemyDeathEffect(Point loc) {
        super(loc);
        animationController = new AnimationController(AnimationController.Mode.AUTO, "mercury_large_enemy_die_left");
