...
* @since   2017-02-18 
*/
public class FlakPickup extends Tile {


    private static BufferedImage flakSpriteSheet = null;
    private int step;
    ...
    * @param loc
    */
    public FlakPickup(Point loc) {
        //call superclass constructor
        super(loc);
        
        animationController = new AnimationController(AnimationController.Mode.AUTO, "flak_pickup");
