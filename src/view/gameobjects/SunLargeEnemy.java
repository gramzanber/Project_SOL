...
* @since   2017-02-18 
*/
public class SunLargeEnemy extends RenderableObject
{   
    ...
    * @param height
    */
    public SunLargeEnemy(Point loc, ID id)
    {
        ...
        animationController = new AnimationController(AnimationController.Mode.AUTO, "sun_large_enemy_run_left");
    ...
    */
    ...
    public void render(Graphics2D g2, Rectangle viewport)
    {
        ...
        if(viewport.intersects(this.getBoundingBox()))
        {
            ...
            if (directionLeft) {
                animationController.setSpriteSheet("sun_large_enemy_run_left");
                ...
                animationController.setSpriteSheet("sun_large_enemy_run_right");
                BufferedImage sprite = animationController.getFrame();
                g2.drawImage(sprite, translatedX, translatedY, (int) boundingBox.getWidth() - border * 2, (int) boundingBox.getHeight() - border * 2, null);
                animationController.update();
            }
