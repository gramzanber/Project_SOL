...
* @since   2017-02-18 
*/
public class AcidBottom extends Tile {


    private static BufferedImage acidBottomSpriteSheet = null;
    private int step;
    ...
    * @param loc
    */
    public AcidBottom(Point loc, ID id) {
        //call superclass constructor
        super(loc);
        this.id = id;
        
        animationController = new AnimationController(AnimationController.Mode.AUTO, "acid_bottom");
