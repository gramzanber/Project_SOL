...
* @since   2017-02-18 
*/
public class HealthPickup extends Tile {


    private static BufferedImage healthSpriteSheet = null;
    private int step;
    ...
    * @param loc
    */
    public HealthPickup(Point loc) {
        //call superclass constructor
        super(loc);
        
        animationController = new AnimationController(AnimationController.Mode.AUTO, "energy_tank");
