...
* @since   2017-02-18 
*/
public class SunLargeEnemyLeftDeathEffect extends RenderableObject {
    
    private AnimationController animationController;
    
    public SunLargeEnemyLeftDeathEffect(Point loc) {
        super(loc);
        animationController = new AnimationController(AnimationController.Mode.AUTO, "sun_large_enemy_die_left");
