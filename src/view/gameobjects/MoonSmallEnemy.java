...
* @since   2017-02-18 
*/
public class MoonSmallEnemy extends RenderableObject
{   
    ...
    * @param height
    */
    public MoonSmallEnemy(Point loc, ID id)
    {
        //call superclass constructor
        super(loc);
        this.id = id;
        
        animationController = new AnimationController(AnimationController.Mode.AUTO, "alien_5-walkleft");
    ...
    */
    ...
    public void render(Graphics2D g2, Rectangle viewport)
    {
        ...
        if(viewport.intersects(this.getBoundingBox()))
        {
            ...
            if (directionLeft) {
                animationController.setSpriteSheet("alien_5-walkleft");
                ...
                animationController.setSpriteSheet("alien_5-walkright");
                BufferedImage sprite = animationController.getFrame();
                g2.drawImage(sprite, translatedX, translatedY, (int) boundingBox.getWidth() - border * 2, (int) boundingBox.getHeight() - border * 2, null);
                animationController.update();
            }
