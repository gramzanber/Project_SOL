...
* @since   2017-02-18 
*/
public class MissilePickup extends Tile {


    private static BufferedImage missileSpriteSheet = null;
    private int step;
    ...
    * @param loc
    */
    public MissilePickup(Point loc) {
        //call superclass constructor
        super(loc);
        
        animationController = new AnimationController(AnimationController.Mode.AUTO, "missile_pickup");
